...
ActiveRecord::Schema[8.1].define(version: 2026_07_13_100000) do
  ...
  create_table "missions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["region_id", "name"], name: "index_missions_on_region_id_and_name", unique: true
  ...
  create_table "quests", force: :cascade do |t|
    ...
    t.bigint "region_id", null: false
    t.datetime "updated_at", null: false
    t.index ["region_id", "name"], name: "index_quests_on_region_id_and_name", unique: true
  ...
  create_table "regions", force: :cascade do |t|
    ...
    t.integer "position"
    t.datetime "updated_at", null: false
    t.index ["campaign_id", "name"], name: "index_regions_on_campaign_id_and_name", unique: true
